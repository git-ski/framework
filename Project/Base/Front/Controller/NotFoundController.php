...
use Project\Base\Front\View\ViewModel\NotFoundViewModel;
use Std\HttpMessageManager\HttpMessageManagerAwareInterface;

class NotFoundController extends AbstractController implements
    HttpMessageManagerAwareInterface
{
    ...
    public function index()
    {
        ...
        $this->getHttpMessageManager()->setResponse($Response->withStatus(404));
