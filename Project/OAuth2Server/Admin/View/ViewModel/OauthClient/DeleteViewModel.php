...
use Project\OAuth2Server\Admin\Fieldset\OauthClientDeleteFieldset;
...
{
    protected $template = '/template/oauthClient/delete.twig';
    protected $finishTemplate = '/template/oauthClient/delete_finish.twig';
    ...
    protected $fieldset = [
        OauthClientDeleteFieldset::class
    ];
