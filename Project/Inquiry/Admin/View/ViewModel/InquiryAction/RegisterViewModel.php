...
use Project\Inquiry\Admin\Fieldset\InquiryActionRegisterFieldset;
...
{
    protected $template = '/template/inquiryAction/register.twig';
    protected $confirmTemplate = '/template/inquiryAction/register.twig';
    ...
    protected $fieldset = [
        InquiryActionRegisterFieldset::class
    ];
