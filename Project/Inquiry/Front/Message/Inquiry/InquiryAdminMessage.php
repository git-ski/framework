 ...
 * @link     https://github.com/git-ski/framework
 */
class InquiryAdminMessage extends StdMessage implements
    HttpMessageManagerAwareInterface
{
    use \Std\HttpMessageManager\HttpMessageManagerAwareTrait;

    protected $textTemplate = '/template/inquiry_admin_text.twig';

    protected $subject = '【WEB予約システム】お客様からお問い合わせがありました';
